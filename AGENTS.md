...
4. If you're updating code in non-minor ways, also run the Cypress e2e test suite via `yarn cypress` and `yarn build`. It takes a few minutes so do it sparingly.
