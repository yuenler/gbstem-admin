  ...
  <Control>
    {#snippet children({ props })}
      ...
      <select
        ...
        bind:value
        class={cn(
          'block h-12 w-full rounded-md border border-gray-400 bg-white px-3 transition-colors focus:border-gray-600 focus:outline-hidden disabled:bg-white disabled:text-gray-400',
          className,
        )}
        {...$$restProps}
      >
