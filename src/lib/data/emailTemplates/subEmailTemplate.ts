...
Thank you for applying to be a gbSTEM instructor. You have been selected as a substitute instructor for this semester. This was our most selective semester yet, so we were not able to accept you as a full instructor, but we were impressed with your application and would still like to invite you to get a chance to teach as a reserve substitute! Success and active participation in this role will significantly help boost your application in future semesters. As a next step, please mark your calendar to attend our <strong>MANDATORY</strong> virtual instructor orientation for the semester on <strong>{{app.orientation}}</strong>. Please email and let us know <strong>IMMEDIATELY</strong> if this time does not work for you so we can schedule a makeup session. The link to join is here: {{app.orientationLink}}. Thank you for your dedication to our program!
                          </p>
