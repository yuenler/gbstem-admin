...
Thank you for applying to be a gbSTEM instructor. You have been selected as a substitute instructor for this semester. This was our most selective semester yet, so we were not able to accept you as a full instructor, but we were impressed with your application and would still like to invite you to get a chance to teach as a reserve substitute! Success and active participation in this role will significantly help boost your application in future semesters. As a next step, please attend our <strong>MANDATORY</strong> instructor orientation for the semester on <strong>Friday, September 20th at 7 pm EDT</strong>. If you cannot make that time, there will be a make up session on <strong>Saturday, September 21st at 3 pm EDT.</strong> However, you are strongly encouraged to attend the first session. Please email and let us know <strong>IMMEDIATELY</strong> if neither of these times work for you. The link to join is here: https://uchicago.zoom.us/j/5405925135?pwd=bFd1a3Q2ZWpEY1lzN0tVYXEvRDI2QT09. Thank you for your dedication to our program!
                          </p>
                      ...
                      <td align="center"
                        ...
                        <div
                          ...
                          <p style="margin: 10px 0"><a target="_blank" rel="noopener noreferrer" style="color: darkblue"
                              ...
                              rel="noopener noreferrer" style="color: darkblue" href="{{app.link}}"><span
