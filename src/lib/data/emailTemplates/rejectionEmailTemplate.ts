...
// Source: src/lib/emails/templates/rejectionEmailTemplate.mjml
// Regenerate with `yarn email:build`. See src/lib/emails/README.md.
export const rejectionEmailTemplate = `<!doctype html>
    ...
    @media only screen and (max-width:479px) {
      ...
      ><p style="margin: 20px 0">Hello {{ app.firstName }},</p>
          <p style="margin: 20px 0">
            Thank you for applying to be a gbSTEM instructor. We are sorry to
            inform you that you were not accepted as an instructor this
            semester. We assure you that this decision was not made easily, as
            this was our most competitive application round ever. We continue to
