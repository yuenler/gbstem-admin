...
// Source: src/lib/emails/templates/acceptEmailTemplate.mjml
    ...
    @media only screen and (max-width:479px) {
      ...
      ><p style="margin: 20px 0">Hello {{ app.firstName }},</p>
          <p style="margin: 20px 0">
            We are happy to announce that you have been accepted as an
            instructor for the upcoming semester. This was our most selective
            semester yet, so congratulations on your acceptance! As a next step,
            please mark your calendar to attend our
