...
We are happy to announce that you have been accepted as an instructor for the upcoming semester. This was our most selective semester yet, so congratulations on your acceptance! As a next step, please attend our <strong>MANDATORY</strong> instructor orientation for the semester on <strong>Thursday, March 6th at 9 pm ET</strong>. If you cannot make that time, there will be a make up session on <strong>Monday, March 10th at 8 pm ET.</strong> Please email and let us know <strong>IMMEDIATELY</strong> if neither of these times work for you. The link to join is here: https://bostonu.zoom.us/j/94670504876?pwd=uDXubKv9Pk02ipoQAxpKq2TLq1IrVW.1. Thank you for your dedication to our program!
                          </p>
