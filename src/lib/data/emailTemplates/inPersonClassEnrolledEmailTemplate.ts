...
// Source: src/lib/emails/templates/inPersonClassEnrolledEmailTemplate.mjml
  ...
  <head>
    ...
    @media only screen and (max-width:479px) {
      ...
      ><p style="margin: 20px 0"></p>
          ...
          Thanks for enrolling {{ app.studentName }} for an in-person
          {{ app.course }} class with us this semester! The class will meet on
          {{ app.class1Time }} weekly in person at the Cambridge Public Library.
          Your instructor will be {{ app.instructor }}. You can email them at
