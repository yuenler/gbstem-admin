...
// Source: src/lib/emails/templates/actionEmailTemplate.mjml
    ...
    @media only screen and (max-width:479px) {
      ...
      >
        <tbody>
              ...
              <tr>
                <td
                   align="left" style="font-size:0px;padding:0px 25px 15px 25px;word-break:break-word;"
                >
      ...
      ><p style="margin: 0 0">{{ action.description }}</p></div>
      ...
      >
        <tbody>
          <tr>
            ...
            >
              <a
                 href="{{url action.link}}" style="display:inline-block;background:darkblue;color:#ffffff;font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:14px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:15px 25px 15px 25px;mso-padding-alt:0px;border-radius:100px;" target="_blank"
              >
                <b style="font-weight: 700"
            ><b style="font-weight: 700">{{ action.name }}</b></b
          >
              </a>
            </td>
          </tr>
      ...
      ><p style="margin: 30px 0">
            ...
            Additionally, if the above button does not work, you can manually
            visit
            <a
              target="_blank"
              rel="noopener noreferrer"
              style="color: darkblue"
              href="{{url action.link}}"
              >{{ action.link }}</a
            >.
          </p>
          <p style="margin: 30px 0">
            For any questions or concerns, visit our FAQs or reach us at
            <a
              target="_blank"
              rel="noopener noreferrer"
              style="color: darkblue"
