...
// Source: src/lib/emails/templates/scheduleInterviewEmailTemplate.mjml
  ...
  <head>
    ...
    @media only screen and (max-width:479px) {
      ...
      ><h1
            ...
            "
          >
            Schedule your gbSTEM interview
          </h1></div>
      ...
      ><p style="margin: 20px 0">Hello {{ app.firstName }},</p>
          <p style="margin: 20px 0">
            Thank you for applying to be a gbSTEM instructor! We would like to
            learn some more about you. Please schedule an interview with us
            through the applicant portal. Be sure to have scheduled an interview
            by {{ app.deadline }}.
          </p>
      ...
      >
        <tbody>
          <tr>
            ...
            ><b style="font-weight: 700">Schedule Interview</b></b
          >
              </a>
            </td>
          </tr>
